...
let actionsFunction = {
  ...
  // Find by cName
  findBycName: function(key) {
    return function(dispatch) {
      return CourseApi
        .findBycName(key)
        .then(item => {
          dispatch(actionsFunction.findBycNameSuccess(item));
        })
        .catch(error => {
          throw error;
        });
  ...
  findBycNameSuccess: function(item) {
    return { type: types.FINDBYCNAME_COURSE_SUCCESS, payload: item };
  },
